...
- **LUT とカメラ JPEG のトーン差**: 撮って出しと比べると中間調がやや明るくハイライトがやや暗いが、LUT の後ろに固定の補正カーブを入れても別の機種には効かなかった（#10）。X100VI で当てはめると X-T5 / X-H1 で悪化し、逆も同じ。差は機種やカットごとのもので、今は補正しない。サンプルが増えたら見直す
